...
print 'Input mass of planet 1 ->',
m1 = float(raw_input())
print 'Input mass of planet 2 ->',
m2 = float(raw_input())
...
print 'Input velocity in y direction of planet 1 ->',
vy10 = float(raw_input())
