...
inivelo = float(raw_input())
print 'Input batting angle ->',
batangle = float(raw_input())
print 'Input x component of spin ->',
spinx = float(raw_input())
print 'Input y component of spin ->',
spiny = float(raw_input())
print 'Input z component of spin ->',
spinz = float(raw_input())
baseball = baseball_state(inivelo,batangle,spinx,spiny,spinz,1,0,0,0,0)
baseball.calculate()
